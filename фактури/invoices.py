"""Invoice extractor — scan PDFs/photos and extract fields to Excel."""
...
def render_invoices_module() -> None:
    """Invoice extractor — Logistics module."""
    st.title("Фактури")
    st.caption("Gemini Flash · извличане на данни и артикули от фактури")
